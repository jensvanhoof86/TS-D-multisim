REM py multisim.py sim.txt  --enable-server --starttime 152900 --port COM9 --protocol DSM115200 --DSM-out COM8 --nmea-out COM10 --enable-remapDSM00 --loop
py multisim.py sim.txt  --enable-server  --port COM15 --protocol AMP19200 --DSM-out COM9 --nmea-out COM10 --enable-remapDSM00 --loop
